    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(choices=[('male', '\u7537'), ('male', '\u7537')], default='female', max_length=6, verbose_name='\u6027\u522b')),
                ('gender', models.CharField(max_length=11, verbose_name='\u7535\u8bdd')),
                ('email', models.CharField(blank=True, max_length=100, null=True, verbose_name='\u59d3\u540d')),
